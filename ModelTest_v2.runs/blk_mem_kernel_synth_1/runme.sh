...
HD_PWD='E:/Users/dell/Vivado/ModelTest_v2/ModelTest_v2.runs/blk_mem_kernel_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_kernel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_kernel.tcl

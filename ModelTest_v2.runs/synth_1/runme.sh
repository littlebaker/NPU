...
HD_PWD='E:/Users/dell/Vivado/ModelTest_v2/ModelTest_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LayerTop_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LayerTop_v2.tcl

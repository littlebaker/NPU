...
HD_PWD='E:/Users/dell/Vivado/ModelTest_v2/ModelTest_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LayerTop_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LayerTop_v2.tcl -notrace
